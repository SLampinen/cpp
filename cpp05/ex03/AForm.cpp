...
/*   Updated: 2024/01/25 11:25:05 by slampine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char* AForm::DoWhenNotExistException::what() const throw()
{
...
void AForm::beSigned(const Bureaucrat& bur)
{
	if (this->getName().empty())
		throw AForm::DoWhenNotExistException();
